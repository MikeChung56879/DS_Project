...
#Save it
ggsave(plot = Treatment_boxplot, filename = "Treatment Boxplot.jpg")
```
...
#Save it
ggsave(plot = Damage_boxplot, filename = "Damage Boxplot.jpg")
```
...
Length_remaining_scatterplot = ggplot()+
  ...
  theme_classic()
#Save it
ggsave(plot = Length_remaining_scatterplot, filename = "Length_remaining_scatterplot.jpg")
```
...
ggsave(plot = Percent.amp.growth, filename = "P.a.g_scatterplot.jpg")
